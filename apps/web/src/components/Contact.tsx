  ...
  return (
    ...
    <section id="contact" className="relative py-16 px-6 overflow-hidden">
      ...
      <img
        ...
        alt=""
        className="absolute -right-16 sm:right-0 -bottom-[50px] sm:bottom-auto sm:top-16 md:top-12 z-10 h-[600px] sm:h-[400px] md:h-[500px] lg:h-[600px] pointer-events-none"
      />


      {/* ── BLUR LAYER ── */}
      {/* Размывает фон + анимированную картинку */}
      <div className="absolute inset-0 z-20 backdrop-blur-[5px] pointer-events-none" />
        ...
        <div className="border border-slate-600/40 p-8 md:p-12 bg-slate-950/60 backdrop-blur-sm">
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <h3 className="text-xl font-mono text-slate-100/90 mb-4 tracking-wider">
                EMAIL
              </h3>
              ...
              <p className="mt-3 text-slate-400 font-mono text-sm tracking-wider">
                @zorker_torker
              </p>
